...
function getHomepageMenuLocks() {
    ...
    const locked = {};
    const menuItems = [
        'war.html', 'missions.html', 'production.html', 'units.html', 'structures.html',
        'blackmarket.html', 'officersmess.html', 'profile.html', 'alliance.html',
        'halloffame.html', 'chats.html', 'events.html', 'settings.html', 'support'
    ];
    menuItems.forEach(item => {
        if (item === 'war.html' || item === 'missions.html') {
            locked[item] = false;
        } else if (['production.html', 'blackmarket.html', 'officersmess.html'].includes(item)) {
